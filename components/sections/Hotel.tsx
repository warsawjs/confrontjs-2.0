...
export default function Hotel() {
  return (
    <div className="flex flex-col gap-20 px-48 py-40">
      <div className="flex flex-col items-center gap-10 text-center">
        <h1 className="font-bold text-2xl lg:text-4xl">WHERE TO STAY?</h1>
          ...
          return (
            <div className="flex flex-col items-center gap-5 pb-10 text-center">
              ...
              <div className="w-[145px] h-[120px] lg:w-[300px] lg:h-[200px] flex flex-col items-center justify-around">
                ...
                <div className="w-20 h-10 flex items-center justify-center bg-tertiary text-secondary rounded-xl">
