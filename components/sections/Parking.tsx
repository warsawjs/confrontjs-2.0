    ...
    <div className="flex flex-col items-center justify-center text-sm lg:text-base py-20">
      ...
      <div className="flex flex-col items-center text-center gap-10 py-10 lg:py-20">
        <div className="flex flex-col items-center text-center gap-5">
          <h1 className="font-bold text-2xl lg:text-4xl uppercase">PARKING</h1>
        ...
        <div className="flex flex-col items-center text-center gap-5">
          ...
          <p className="w-[307px] lg:w-[640px]">{venue.entry}</p>
        </div>

        <div className="flex flex-col items-center text-center gap-5">
          <h2 className="font-bold text-xl lg:text-2xl uppercase">EXITS:</h2>
          <p className="w-[307px] lg:w-[640px]">{venue.exit}</p>
        </div>
        <Link
          href="/buy-a-ticket"
