        ...
        {data.map((conference: any) => {
          return (
            <div className="flex flex-col items-center gap-5 pb-20">
              ...
              <div className="flex items-center w-[250px] h-[200px] lg:w-[400px] lg:h-[350px] rounded-3xl overflow-hidden drop-shadow-xl">
                <Image
                  className="h-full"
                  width={1000}
                  height={1000}
              ...
              <Link
                className="font-bold uppercase px-6 py-4 bg-primary rounded-xl text-sm text-white"
                href={conference.url}
              >
                SEE MORE PHOTOS
              </Link>
