  ...
  <>
    <div className="flex flex-col items-center py-40 text-base">
      <div className={`${variant === "main" ? "flex" : "hidden"} flex flex-col-reverse lg:flex-row items-center justify-center gap-12`}>
        ...
        <div className="w-[306px] lg:w-[523px] h-[310px] rounded-3xl bg-tertiary">
          <img src={venue.img}/>
        </div>
      </div>
      ...
      <div className={`${variant === "venue" ? "flex" : "hidden"} flex-col items-center gap-20`}>
        <div className="flex flex-col lg:flex-row justify-center gap-20">
          <div className="w-[306px] h-[310px] lg:w-[452px] lg:h-[524px] rounded-3xl bg-tertiary">
            <img className="object-fit" src={venue.img}/>
          </div>
          <div className="flex flex-col text-center lg:text-left justify-around gap-10 py-4">
            <h2 className="font-bold text-2xl uppercase">About Pałac Kultury</h2>
            <p className="w-[306px] lg:w-[520px]">{venue.about}
            </p>
          </div> 
        </div>
        <Link
